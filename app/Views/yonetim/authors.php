    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 pb-12">
            <section class="space-y-6">
                <div class="brutalist-card p-8 bg-[var(--bg-secondary)]/20">
                    ...
                    <form action="/yonetim/author-store" method="POST" enctype="multipart/form-data" class="space-y-4">
                        <?= Csrf::field() ?>
            ...
            <section class="space-y-4">
                ...
                <div class="brutalist-card p-4 bg-[var(--bg-paper)] flex items-center justify-between">
                    ...
                    <div class="flex gap-2">
                        ...
                        <form method="POST" action="/yonetim/author-delete?id=<?php echo $author['id']; ?>" onsubmit="return confirm('Kayıt silinsin mi?')" class="inline">
                            <?= Csrf::field() ?>

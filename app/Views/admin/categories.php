...
<body class="flex h-screen w-full overflow-hidden relative">
    ...
    <div class="flex flex-col md:flex-row gap-12 h-full pb-6">
            ...
            <div class="w-full md:w-1/3">
                ...
                <form action="/yonetim/store-category" method="POST" class="border-2 border-[var(--text-main)] p-6 shadow-[8px_8px_0px_#A31D1D] bg-[var(--bg-paper)]">
                    <?= Csrf::field() ?>
                    <div class="mb-6">
                    ...
                    <table class="w-full text-left font-mono text-xs border-collapse">
                        <thead class="bg-[#6D2323] text-[#FEF9E1] uppercase sticky top-0 z-20">
                            <tr>
                                ...
                                <th class="p-4 border-b border-[var(--text-main)]">Makale Sayısı</th>
                        ...
                        <tbody class="divide-y divide-[var(--text-main)]/10">
                            ...
                            <tr class="hover:bg-[var(--bg-secondary)]/30 transition-colors">
                                ...
                                <td class="p-4">
                                    <span class="bg-[#6D2323]/10 px-2 py-1 rounded">
                                        <?php echo $cat['article_count']; ?> Makale
                                    </span>
                                </td>
                                <td class="p-4">
                                ...
                                <td class="p-4 text-right">
                                    <form method="POST" action="/yonetim/delete-category"
                                          data-confirm="Bu kategoriyi silmek istediğinize emin misiniz?"
                                          class="inline">
                                        <?= Csrf::field() ?>
                            ...
                            <?php endforeach; else: ?>
                                <tr><td colspan="5" class="p-8 text-center opacity-50 uppercase font-mono italic">// Henüz kategori tanımlanmadı.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>

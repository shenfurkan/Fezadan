...
<main class="relative z-10 w-full max-w-[1920px] mx-auto flex-grow">
    ...
    <div class="grid-layout">
        ...
        <aside class="sidebar">
            ...
            <div class="sticky top-12 px-6 py-12 lg:p-16 2xl:p-20" style="padding-left: 20px;">
                <div class="relative">
                    ...
                    <h1 class="font-syne text-5xl md:text-6xl lg:text-4xl xl:text-5xl 2xl:text-7xl font-bold uppercase leading-[0.9] tracking-tighter text-[var(--text-main)] mb-6 break-words">
                        Gerilla<br>Açık Erişim<br>Mani&shy;festo&shy;su
                    </h1>
                </div>
                
                <div class="space-y-6 mt-8 xl:mt-12">
                    <div class="p-4 border-l-2 border-[var(--text-main)] bg-black/5 dark:bg-white/5">
                        <p class="font-mono text-xs uppercase tracking-widest text-[var(--text-main)] mb-2">Bağlam</p>
